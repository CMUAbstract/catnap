...
PERIOD(p2, sec_to_tick(1), sec_to_tick(1));
...
void fft(const float *buf, float *result, unsigned size)
{
	// FFT lib
	...
	switch (size) {
		case 64:
			twiddle_table = float_twiddle_table_64_q15;
			break;
		case 32:
			twiddle_table = float_twiddle_table_32_q15;
			break;
		case 16:
			twiddle_table = float_twiddle_table_16_q15;
			break;
	}
